...
def test_q6_r_and_ri_apply_extension(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 8, b'\x00\x40\x00\x0c\xc1\xc0\x00\x76')
    hexagon.registers.general[0] = 0x50000005
    hexagon.cycle()
    assert hexagon.registers.general[1] == 0x40000004
