...
class ConditionalTransferNotNew(ConditionalTransfer):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, d=d, pu=u2, imm=imm, dot_new=True, sense=False)

    def __repr__(self):
        return f'if (!P{self.pu}.new) R{self.d}=#{self.imm}'
