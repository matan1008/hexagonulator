...
from ..abstract.read_b_absolute_register_offset import ReadBAbsoluteRegisterOffset


class ReadBImmRegOff(ReadBAbsoluteRegisterOffset):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.d}=memb(R{self.t}<<#{self.shift}+#{self.imm})'
