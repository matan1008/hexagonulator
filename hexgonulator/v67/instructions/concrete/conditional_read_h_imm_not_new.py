...
from ..abstract.conditional_read_h_absolute import ConditionalReadHAbsolute


class ConditionalReadHImmNotNew(ConditionalReadHAbsolute):
    @classmethod
    ...
    def __repr__(self):
        return f'if (!P{self.pt}.new) R{self.d}=memh(#{self.imm})'
