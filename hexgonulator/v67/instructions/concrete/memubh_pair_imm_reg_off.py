...
from ..abstract.memubh_pair_absolute_register_offset import MemubhPairAbsoluteRegisterOffset


class MemubhPairImmRegOff(MemubhPairAbsoluteRegisterOffset):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.d + 1}:{self.d}=memubh(R{self.t}<<#{self.shift}+#{self.imm})'
