...
def test_conditional_dealloc_return_not_new(hexagon):
    hexagon.registers.framekey = 0x00112233
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xe8\x00\x96')
...
def test_conditional_dealloc_return_not_new_false(hexagon):
