...
from ..abstract.conditional_transfer import ConditionalTransfer as _ConditionalTransfer


class ConditionalTransfer(_ConditionalTransfer):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, d=d, pu=u2, imm=imm)
