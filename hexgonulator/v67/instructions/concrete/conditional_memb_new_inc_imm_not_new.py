...
class ConditionalMembNewIncImmNotNew(ConditionalMembNewIndirectIncrementImm):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, t=t, imm=imm, x=x, pv=v, sense=False, dot_new=True)

    def __repr__(self):
        return f'if (!P{self.pv}.new) memb(R{self.x}++#{self.imm})=N{self.t}.new'
