...
from ..abstract.conditional_jump_reg_lt_zero import ConditionalJumpRegLtZero as _ConditionalJumpRegLtZero


class ConditionalJumpRegLtZeroHint(_ConditionalJumpRegLtZero):
    @classmethod
