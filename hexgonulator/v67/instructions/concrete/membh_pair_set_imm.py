...
from ..abstract.membh_pair_absolute_set import MembhPairAbsoluteSet


class MembhPairSetImm(MembhPairAbsoluteSet):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.d + 1}:{self.d}=membh(R{self.e}=#{self.imm})'
