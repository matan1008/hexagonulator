...
from hexgonulator.v67.instructions.abstract.tstbit_and_jump import TstbitAndJump


class TstbitAndJumpP0Hint(TstbitAndJump):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, r=r9, s=s, pu=0, hint=True)
