...
def test_conditional_add_new_reg(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x02\xe1\x00\xfb')
...
def test_conditional_add_new_reg_predicate_false(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x02\xe1\x00\xfb')
    hexagon.registers.general[0] = 4
