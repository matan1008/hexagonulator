def test_cmp_gtu_and_jump_p1_reg_not(hexagon):
    pc = hexagon.registers.pc
    hexagon.memory.controllers[0].mem.write(0, 4, b'\xfe\xd8\x70\x15')
...
def test_cmp_gtu_and_jump_p1_reg_not_false(hexagon):
    pc = hexagon.registers.pc
    hexagon.memory.controllers[0].mem.write(0, 4, b'\xfe\xd8\x70\x15')
