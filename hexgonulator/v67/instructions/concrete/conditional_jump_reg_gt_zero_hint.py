...
from ..abstract.conditional_jump_reg_gt_zero import ConditionalJumpRegGtZero as _ConditionalJumpRegGtZero


class ConditionalJumpRegGtZeroHint(_ConditionalJumpRegGtZero):
    @classmethod
