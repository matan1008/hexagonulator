...
from ..abstract.conditional_jump import ConditionalJump as _ConditionalJump


class ConditionalJump(_ConditionalJump):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, r=r, pu=u2)

    def __repr__(self):
        return f'if (P{self.pu}) jump:nt PC + #{self.r}'
