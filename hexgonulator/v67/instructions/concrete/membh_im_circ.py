...
from ..abstract.membh_circular_increment import MembhCircularIncrement


class MembhImCirc(MembhCircularIncrement):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.d}=membh(R{self.x}++#{self.imm}:circ(M{self.mu}))'
