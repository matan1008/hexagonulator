...
def test_memubh_pair_m_circ(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xc2\xa0\x98')
...
def test_memubh_pair_m_circ_overflow(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xc2\xa0\x98')
    add_memory(hexagon, b'\xf0\xe0\x30\xf0', 0x40000020)
    hexagon.registers.m0.i = 1
...
def test_memubh_pair_m_circ_underflow(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xc2\xa0\x98')
    add_memory(hexagon, b'\xf0\xe0\x30\xf0', 0x40000020)
