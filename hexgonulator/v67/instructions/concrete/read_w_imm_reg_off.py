...
from ..abstract.read_w_absolute_register_offset import ReadWAbsoluteRegisterOffset


class ReadWImmRegOff(ReadWAbsoluteRegisterOffset):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.d}=memw(R{self.t}<<#{self.shift}+#{self.imm})'
