...
def test_conditional_read_uh_reg_reg_off_not_new(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x82\xc1\x60\x33')
...
def test_conditional_read_uh_reg_reg_off_not_new_false(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x82\xc1\x60\x33')
    add_memory(hexagon, b'\x00\xf0\x00\x00', 0x40000020)
    hexagon.registers.general[0] = 0x40000000
    hexagon.registers.general[1] = 0x10
