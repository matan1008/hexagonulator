...
class ConditionalMembNewRegImmNotNew(ConditionalMembNewIndirectOffset):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, t=t, imm=imm, s=s, pv=pv, sense=False, dot_new=True)

    def __repr__(self):
        return f'if (!P{self.pv}.new) memb(R{self.s}+#{self.imm})=N{self.t}.new'
