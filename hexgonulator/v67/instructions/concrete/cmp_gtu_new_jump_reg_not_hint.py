...
class CmpGtuNewJumpRegNotHint(CmpGtuNewAndJump):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, r=r9, s=s, t=t, sense=False, hint=True)

    def __repr__(self):
        return f'if (!cmp.gtu(N{self.s}.new,R{self.t})) jump:t PC + #{self.r}'
