def test_cmp_gt_and_jump_p0_reg_hint(hexagon):
    pc = hexagon.registers.pc
    hexagon.memory.controllers[0].mem.write(0, 4, b'\xfe\xe8\xb0\x14')
...
def test_cmp_gt_and_jump_p0_reg_hint_false(hexagon):
    pc = hexagon.registers.pc
    hexagon.memory.controllers[0].mem.write(0, 4, b'\xfe\xe8\xb0\x14')
