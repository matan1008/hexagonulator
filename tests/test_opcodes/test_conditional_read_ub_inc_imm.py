...
def test_conditional_read_ub_inc_imm(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\xe1\xe1\x20\x9b')
...
def test_conditional_read_ub_inc_imm_false(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\xe1\xe1\x20\x9b')
    add_memory(hexagon, b'\xf0\x00\x00\x00', 0x40000020)
    hexagon.registers.general[0] = 0x40000020
    hexagon.cycle()
