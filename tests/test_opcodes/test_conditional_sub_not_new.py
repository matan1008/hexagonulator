...
def test_conditional_sub_not_new(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x82\xe1\x20\xfb')
...
def test_conditional_sub_not_new_predicate_false(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x82\xe1\x20\xfb')
    hexagon.registers.general[0] = 5
    hexagon.registers.general[1] = 9
