...
class CmpGtAndJumpP1Minus1Not(CmpGtAndJump):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, r=r9, s=s, pu=1, imm=-1, sense=False)

    def __repr__(self):
        return f'p{self.pu}=cmp.gt(R{self.s},#-1); if (!p{self.pu}.new) jump:nt PC + #{self.r}'
