...
from ..abstract.memh_fifo_indirect_with_offset import MemhFifoIndirectWithOffset


class MemhFifoRegImm(MemhFifoIndirectWithOffset):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.y + 1}:{self.y}=memh_fifo(R{self.s}+#{self.imm})'
