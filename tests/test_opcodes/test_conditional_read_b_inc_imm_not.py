...
def test_conditional_read_b_inc_imm_not(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\xe1\xe9\x00\x9b')
...
def test_conditional_read_b_inc_imm_not_false(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\xe1\xe9\x00\x9b')
    add_memory(hexagon, b'\xf0\x00\x00\x00', 0x40000020)
    hexagon.registers.general[0] = 0x40000020
