...
def test_conditional_zxtb_new(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xe4\x80\x70')
...
def test_conditional_zxtb_new_predicate_false(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xe4\x80\x70')
    hexagon.registers.general[0] = 0x11223344
