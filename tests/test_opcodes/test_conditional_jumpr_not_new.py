...
def test_conditional_jumpr_not_new(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x00\xc8\x60\x53')
...
def test_conditional_jumpr_not_new_false(hexagon):
