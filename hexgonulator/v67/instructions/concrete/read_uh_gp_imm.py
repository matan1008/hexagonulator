...
from ..abstract.read_uh_global_pointer_relative import ReadUhGlobalPointerRelative


class ReadUhGpImm(ReadUhGlobalPointerRelative):
    @classmethod
    ...
    def __repr__(self):
        ...
        return f'R{self.d}=memuh({gp}#{self.imm})'
