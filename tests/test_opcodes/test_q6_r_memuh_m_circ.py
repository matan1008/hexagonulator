...
def test_q6_r_memuh_m_circ(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xc2\x60\x99')
...
def test_q6_r_memuh_m_circ_overflow(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xc2\x60\x99')
    add_memory(hexagon, b'\x00\xf0\x00\x00', 0x40000020)
    hexagon.registers.m0.i = 1
...
def test_q6_r_memuh_m_circ_underflow(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xc2\x60\x99')
    add_memory(hexagon, b'\x00\xf0\x00\x00', 0x40000020)
