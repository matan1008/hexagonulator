...
class CmpGtuNewJumpImmNotHint(CmpGtuNewAndJump):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, r=r9, s=s, imm=imm, sense=False, hint=True)

    def __repr__(self):
        return f'if (!cmp.gtu(N{self.s}.new,#{self.imm})) jump:t PC + #{self.r}'
