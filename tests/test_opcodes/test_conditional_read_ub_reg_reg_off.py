...
def test_conditional_read_ub_reg_reg_off(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x82\xc1\x20\x30')
...
def test_conditional_read_ub_reg_reg_off_false(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x82\xc1\x20\x30')
    add_memory(hexagon, b'\xf0\x00\x00\x00', 0x40000020)
    hexagon.registers.general[0] = 0x40000000
    hexagon.registers.general[1] = 0x10
