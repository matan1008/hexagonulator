...
from ..abstract.read_uh_absolute_register_offset import ReadUhAbsoluteRegisterOffset


class ReadUhImmRegOff(ReadUhAbsoluteRegisterOffset):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.d}=memuh(R{self.t}<<#{self.shift}+#{self.imm})'
