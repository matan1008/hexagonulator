...
from ..abstract.read_h_absolute_register_offset import ReadHAbsoluteRegisterOffset


class ReadHImmRegOff(ReadHAbsoluteRegisterOffset):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.d}=memh(R{self.t}<<#{self.shift}+#{self.imm})'
