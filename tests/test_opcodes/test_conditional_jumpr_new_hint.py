...
def test_conditional_jumpr_new_hint(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x00\xd8\x40\x53')
...
def test_conditional_jumpr_new_hint_false(hexagon):
