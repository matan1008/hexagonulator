...
from ..abstract.memubh_indirect_with_offset import MemubhIndirectWithOffset


class MemubhRegImm(MemubhIndirectWithOffset):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.d}=memubh(R{self.s}+#{self.imm})'
