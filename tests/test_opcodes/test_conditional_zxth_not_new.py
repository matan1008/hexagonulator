...
def test_conditional_zxth_not_new(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xec\xc0\x70')
...
def test_conditional_zxth_not_new_predicate_false(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xec\xc0\x70')
    hexagon.registers.general[0] = 0x11223344
