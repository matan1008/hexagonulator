...
from ..abstract.conditional_jump_reg_eq_zero import ConditionalJumpRegEqZero as _ConditionalJumpRegEqZero


class ConditionalJumpRegEqZero(_ConditionalJumpRegEqZero):
    @classmethod
