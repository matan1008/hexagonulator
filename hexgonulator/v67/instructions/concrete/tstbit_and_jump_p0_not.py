...
class TstbitAndJumpP0Not(TstbitAndJump):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, r=r9, s=s, pu=0, sense=False)

    def __repr__(self):
        return f'p{self.pu}=tstbit(R{self.s},#0); if (!p{self.pu}.new) jump:nt PC + #{self.r}'
