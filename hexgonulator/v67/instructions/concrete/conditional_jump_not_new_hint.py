...
class ConditionalJumpNotNewHint(ConditionalJump):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, r=r, pu=u2, sense=False, hint=True, dot_new=True)

    def __repr__(self):
        return f'if (!P{self.pu}.new) jump:t PC + #{self.r}'
