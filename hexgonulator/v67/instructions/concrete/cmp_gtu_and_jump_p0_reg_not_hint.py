...
class CmpGtuAndJumpP0RegNotHint(CmpGtuAndJump):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, r=r9, s=s, pu=0, t=t, sense=False, hint=True)

    def __repr__(self):
        return f'p{self.pu}=cmp.gtu(R{self.s},R{self.t}); if (!p{self.pu}.new) jump:t PC + #{self.r}'
