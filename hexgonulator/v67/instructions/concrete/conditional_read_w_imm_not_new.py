...
from ..abstract.conditional_read_w_absolute import ConditionalReadWAbsolute


class ConditionalReadWImmNotNew(ConditionalReadWAbsolute):
    @classmethod
    ...
    def __repr__(self):
        return f'if (!P{self.pt}.new) R{self.d}=memw(#{self.imm})'
