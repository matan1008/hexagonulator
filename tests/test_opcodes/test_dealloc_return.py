...
def test_dealloc_return(hexagon):
    hexagon.registers.framekey = 0x00112233
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x01\xc0\x00\x96')
...
def test_dealloc_return_fp(hexagon):
    hexagon.registers.framekey = 0x00112233
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x1e\xc0\x1e\x96')
    add_memory(hexagon, b'\x00\x11\x22\x33\xff\x00\xff\x00', 0x40000020)
