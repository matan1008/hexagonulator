...
class CmpGtuAndJumpP1RegNot(CmpGtuAndJump):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, r=r9, s=s, pu=1, t=t, sense=False)

    def __repr__(self):
        return f'p{self.pu}=cmp.gtu(R{self.s},R{self.t}); if (!p{self.pu}.new) jump:nt PC + #{self.r}'
