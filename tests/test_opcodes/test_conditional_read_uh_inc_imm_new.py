...
def test_conditional_read_uh_inc_imm_new(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\xe1\xf1\x60\x9b')
...
def test_conditional_read_uh_inc_imm_new_false(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\xe1\xf1\x60\x9b')
    add_memory(hexagon, b'\x00\xf0\x00\x00', 0x40000020)
    hexagon.registers.general[0] = 0x40000020
