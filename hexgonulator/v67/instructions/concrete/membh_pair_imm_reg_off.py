...
from ..abstract.membh_pair_absolute_register_offset import MembhPairAbsoluteRegisterOffset


class MembhPairImmRegOff(MembhPairAbsoluteRegisterOffset):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.d + 1}:{self.d}=membh(R{self.t}<<#{self.shift}+#{self.imm})'
