...
def test_conditional_memb_new_inc_imm_not(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 8, b'\x03\x40\x62\x70\x7c\xe2\xa0\xab')
...
def test_conditional_memb_new_inc_imm_not_false(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 8, b'\x03\x40\x62\x70\x7c\xe2\xa0\xab')
    mem = add_memory(hexagon, b'\x00\x00\x00\x00', 0x40000020)
    hexagon.registers.general[0] = 0x40000020
    hexagon.registers.general[2] = 0x44332211
