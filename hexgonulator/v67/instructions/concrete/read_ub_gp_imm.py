...
from ..abstract.read_ub_global_pointer_relative import ReadUbGlobalPointerRelative


class ReadUbGpImm(ReadUbGlobalPointerRelative):
    @classmethod
    ...
    def __repr__(self):
        ...
        return f'R{self.d}=memub({gp}#{self.imm})'
