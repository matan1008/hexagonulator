...
def test_conditional_combine_new(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x02\xe1\x00\xfd')
...
def test_conditional_combine_new_predicate_false(hexagon):
    hexagon.memory.controllers[0].mem.write(0, 4, b'\x02\xe1\x00\xfd')
    hexagon.registers.general[0] = 0x55667788
    hexagon.registers.general[1] = 0x11223344
