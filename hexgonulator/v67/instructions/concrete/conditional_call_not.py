...
from ..abstract.conditional_call import ConditionalCall as _ConditionalCall


class ConditionalCallNot(_ConditionalCall):
    @classmethod
    def from_int(cls, instr, apply_extension=None):
        ...
        return cls(instr, r=r, pu=u2, sense=False)

    def __repr__(self):
        return f'if (!P{self.pu}) call PC + #{self.r}'
