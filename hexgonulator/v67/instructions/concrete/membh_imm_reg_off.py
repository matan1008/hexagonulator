...
from ..abstract.membh_absolute_register_offset import MembhAbsoluteRegisterOffset


class MembhImmRegOff(MembhAbsoluteRegisterOffset):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.d}=membh(R{self.t}<<#{self.shift}+#{self.imm})'
