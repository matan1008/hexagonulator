...
from ..abstract.read_uh_indirect_with_offset import ReadUhIndirectWithOffset


class ReadUhRegImm(ReadUhIndirectWithOffset):
    @classmethod
    ...
    def __repr__(self):
        return f'R{self.d}=memuh(R{self.s}+#{self.imm})'
